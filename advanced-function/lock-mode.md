...
1. Under [Modify](../basic-function/geometry/modify.md) and [Vertex Mode](../mode/vertex-mode.md), select an edge for the vertices to lock onto and press `Space` to lock the edge.
2. Under [Modify](../basic-function/geometry/modify.md) and [Vertex Mode](../mode/vertex-mode.md), Click and Drag a vertex in the 3D tool. 
...
1. Under [Modify](../basic-function/geometry/modify.md) and [Surface Mode](../mode/surface-mode.md), select a plane to lock a vertex onto and press `Space` to lock the plane.
2. Under [Modify](../basic-function/geometry/modify.md) and [Vertex Mode](../mode/vertex-mode.md), Hold and Drag the vertex in the 3D tool. 
